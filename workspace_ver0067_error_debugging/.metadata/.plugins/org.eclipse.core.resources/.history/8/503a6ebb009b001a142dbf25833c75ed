...
public class CustomerCare {	
	...
	public static void searchMember(int searchMode, String keyWord) {
		try {
			...
			System.out.println("CustomerCare - searchMember = " +  e.getStackTrace());
		}
	...
	public static void selectAutomobileInfo(String customerID) {
		try {								
			...
			System.out.println("CustomerCare - selectAutomobileInfo = " + e.getStackTrace());
		}
	...
	public static void selectTravelInfo(String customerID) {
		try {								
			...
			System.out.println("CustomerCare - selectTravelInfo = " +  e.getStackTrace());
		}
	...
	public static void selectHomeInfo(String customerID) {
		try {									
			...
			System.out.println("CustomerCare - selectHomeInfo = " +  e.getStackTrace());
		}
	...
	public static void selectDetailedInfo(String customerID) {
		try {									
			...
			System.out.println("CustomerCare - selectDetailedInfo = " +  e.getStackTrace());
		}
	...
	public static void selectFamilyInfo(String customerID) {
		try {									
			...
			System.out.println("CustomerCare - selectFamilyInfo = " +  e.getStackTrace());
		}
	...
	public static void selectCommercialInfo(String customerID) {
		...
		try {									
			...
			System.out.println("CustomerCare - selectCommercialInfo = " +  e.getStackTrace());
		}
	...
	public static void selectCalendarInfo(String customerID) {
		...
		try {											
			...
			System.out.println("CustomerCare - selectCalendarInfo = " +  e.getStackTrace());
		}
	...
	public static boolean submitMember(int dialogMode, String tempID, String LastName, String FirstName, 
		...
		try {
			...
			JOptionPane.showMessageDialog(GUIForCustomerCare.jFrame, "CustomerCare - submitMember - Error", "Error - submitMember", JOptionPane.ERROR_MESSAGE);
		}
	...
	public static boolean submitMemberForAuto(int dialogMode, String tempID, String time_stamp, String txnType, 
		...
		try {
			...
			JOptionPane.showMessageDialog(GUIForCustomerCare.jFrame, "CustomerCare - submitMemberForAuto - Error", "Error - submitMemberForAuto", JOptionPane.ERROR_MESSAGE);
		}
	...
	public static boolean submitMemberForHome(int dialogMode, String tempID, String time_stamp, String expDate,
		...
		try {
			...
			JOptionPane.showMessageDialog(GUIForCustomerCare.jFrame, "CustomerCare - submitMemberForHome - Error", "Error - submitMemberForHome", JOptionPane.ERROR_MESSAGE);
		}
	...
	public static boolean submitMemberForTravel(int dialogMode, String tempID, String time_stamp, String effDate, 
		...
		try {
			...
			JOptionPane.showMessageDialog(GUIForCustomerCare.jFrame, "CustomerCare - submitMemberForTravel - Error", "Error - submitMemberForTravel", JOptionPane.ERROR_MESSAGE);
		}
	...
	public static boolean submitMemberForCommercial(int dialogMode, String tempID, String time_stamp, String expDate, 
		...
		try {
			...
			JOptionPane.showMessageDialog(GUIForCustomerCare.jFrame, "CustomerCare - submitMemberForCommercial - Error", "Error - submitMemberForCommercial", JOptionPane.ERROR_MESSAGE);
		}
	...
	public static boolean insertMemberForOther(int dialogMode, String tempID, String time_stamp) {
		int result = 0;
		...
		try	{
			...
			JOptionPane.showMessageDialog(GUIForCustomerCare.jFrame, "CustomerCare - insertMemberForOther - Error", "Error - insertMemberForOther", JOptionPane.ERROR_MESSAGE);
		}

		...
		if (e.getActionCommand().equals("jButtonOpen")) {
					    ...
					    public boolean accept(File pathname) {
							...
							if (count == 0) {
								try {
									...
									// TODO Auto-generated catch block
									System.out.println("ActionPerformer - OpenButton - Automobile = " + e.getStackTrace());
								} 
							}
	    		...
	    		if (numClicks == 2 || numClicks == 1) {
	        		try
	        		{
	        			...
	        			while (Utilities.resultSet.next()) {			
        	        		...
        	        		{
        	        			System.out.println("ActionPerformer - BackUpButton - Customer - CreateNewFile = " +  e5.getStackTrace());
        	        		}
	    				}
	        		...
	        		{
	        			System.out.println("ActionPerformer - BackUpButton - Customer = " +  e5.getStackTrace());
	        		}
	        		...
	        		try
	        		{
	        			...
	        			while (Utilities.resultAutomobileSet.next()) {			
        	        		...
        	        		{
        	        			System.out.println("ActionPerformer - BackUpButton - Automobile - CreateNewFile = " +  e5.getStackTrace());
        	        		}
	    				}
	        		...
	        		{
	        			System.out.println("ActionPerformer - BackUpButton - Automobile = " +  e5.getStackTrace());
	        		}
	        		//---------------------------------------------Travel
	        		try
	        		{
	        			...
	        			while (Utilities.resultTravelSet.next()) {			
	        				...
	        				try {
	        	        		...
	        	        		{
	        	        			System.out.println("ActionPerformer - BackUpButton - Travel - CreateNewFile = " +  e5.getStackTrace());
	        	        		}
	    				}
	        		...
	        		{
	        			System.out.println("ActionPerformer - BackUpButton - Travel = " +  e5.getStackTrace());
	        		}
	        		//---------------------------------------------------- Home
	        		try
	        		{
	        			...
	        			while (Utilities.resultHomeSet.next()) {			
	        				...
	        				try {
	        	        		...
	        	        		{
	        	        			System.out.println("ActionPerformer - BackUpButton - Home - CreateNewFile = " +  e5.getStackTrace());
	        	        		}
	    				}
	        		...
	        		{
	        			System.out.println("ActionPerformer - BackUpButton - Home = " +  e5.getStackTrace());
	        		}
	        		// --------------------------------------------------------------- Commercial
	        		try
	        		{
	        			...
	        			while (Utilities.resultCommercialInfoSet.next()) {			
	        				...
	        				try {
	        	        		...
	        	        		{
	        	        			System.out.println("ActionPerformer - BackUpButton - Commerical - CreateNewFile = " +  e5.getStackTrace());
	        	        		}
	    				}
	        		...
	        		{
	        			System.out.println("ActionPerformer - BackUpButton - Commerical = " +  e5.getStackTrace());
	        		}
			...
			numClicks++;
	    		...
	    		if (numClicks == 2 || numClicks == 1) {
		    		...
		    		{
		    			System.out.println("ActionPerformer - RestoreButton - Customer = " +  e4.getStackTrace());
		    		}
		    		// ----------------------------------------------------Automobile
		    		try {
		    		...
		    		{
		    			System.out.println("ActionPerformer - RestoreButton - Automobile = " +  e6.getStackTrace());
		    		}
		    		//---------------------------------------------Travel
		    		try {
		    		...
		    		{
		    			System.out.println("ActionPerformer - RestoreButton - Travel = " +  e6.getStackTrace());
		    		}
		    		//---------------------------------------------------- Home
		    		try {
		    		...
		    		{
		    			System.out.println("ActionPerformer - RestoreButton - Home = " +  e6.getStackTrace());
		    		}
	        		// --------------------------------------------------------------- Commercial
		    		try {
		    		...
		    		{
		    			System.out.println("ActionPerformer - RestoreButton - Commercial = " +  e6.getStackTrace());
		    		}
			...
			// what is the difference between jdialog.dispose, and jpanel.removeall? Can things run smoothly without either one?
			// seems that the program runs smoothly, so not going to change anything until something fucks up.
			
			GUIForMemberDialog.idPanel.removeAll();
			GUIForMemberDialog.idPanel.repaint();
			GUIForMemberDialog.idPanelForAuto.removeAll();
			GUIForMemberDialog.idPanelForAuto.repaint();
			GUIForMemberDialog.premiumPanelForAuto.removeAll();
			GUIForMemberDialog.premiumPanelForAuto.repaint();
			GUIForMemberDialog.fieldNamePanel.removeAll();
			GUIForMemberDialog.fieldNamePanel.repaint();
			GUIForMemberDialog.fieldValuePanel.removeAll();
			GUIForMemberDialog.fieldValuePanel.repaint();
			GUIForMemberDialog.timeStampPanelForAuto.removeAll();
			GUIForMemberDialog.timeStampPanelForAuto.repaint();
		}
							...
							case DatabaseConstant.NEW_MODE:
								if (CustomerCare.submitMember(MemberDialog.getDialogMode(), GUIForMemberDialog.idField.getText().trim(), 
									...
									try {
										...
										JOptionPane.showMessageDialog(GUIForMemberDialog.jDialog, "ActionPerformer - submitButton - CustomerMode - NewMode - Error", "Error - submitMember", JOptionPane.ERROR_MESSAGE);
										System.out.println("ActionPerformer - submitButton - CustomerMode - NewMode = " +  e1.getStackTrace());
									}
							...
							case DatabaseConstant.EDIT_MODE:
								if (CustomerCare.submitMember(MemberDialog.getDialogMode(), GUIForMemberDialog.idField.getText().trim(), 
									...
									try {
										...
										JOptionPane.showMessageDialog(GUIForMemberDialog.jDialog, "ActionPerformer - submitButton - CustomerMode - EditMode - Error", "Error - submitMember", JOptionPane.ERROR_MESSAGE);
										System.out.println("ActionPerformer - submitButton - CustomerMode - EditMode = " +  e1.getStackTrace());
									}
								}
								GUIForMemberDialog.jDialogUpdate.dispose();
								break;

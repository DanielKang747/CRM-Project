...
public class GUIForCustomerCare extends Frame {
	...
	public static JFrame jFrame = new JFrame("Queen Bee Diary");
	
	public static DefaultTableModel defaultTableModel_Claim_Info 
	...
	public static DefaultTableModel defaultTableModel_Personal_Info 
	...
	public static DefaultTableModel defaultTableModel_In_Progress_Info 
		= new DefaultTableModel(new String[] { "Customer ID", "Last Name", "First Name", "Exp Date", 
				"Proc Type", "Ins Kind", "Company", "Ownership"}, 0)
	{
		private static final long serialVersionUID = 1L;
	...
	public static DefaultTableModel defaultTableModel_Complete_Info 
		= new DefaultTableModel(new String[] { "Customer ID", "Last Name", "First Name", "Exp Date", 
	...
	public static DefaultTableModel defaultTableModel_Reserved_Info 
		= new DefaultTableModel(new String[] { "Customer ID", "Last Name", "First Name", "Exp Date", 
	...
	public static DefaultTableModel defaultTableModel_All_Info 
		= new DefaultTableModel(new String[] { "Customer ID", "Last Name", "First Name", "Exp Date", 
	...
	public static DefaultTableModel defaultTableModel_Automobile_Info 
	...
	public static DefaultTableModel defaultTableModel_House_Info 
	...
	public static DefaultTableModel defaultTableModel_Traveler_Info 
	...
	public static DefaultTableModel defaultTableModel_Family_Info 
	...
	public static DefaultTableModel defaultTableModel_Commercial_Info 
	...
	public static DefaultTableModel defaultTableModel_Calendar_Info 
	= new DefaultTableModel(new String[] {"Expiry Date", "Last Name", "First Name", "Ins Kind", "Company", "Premium", "Policy No"}, 0)
	{
		private static final long serialVersionUID = 1L;
	...
	public static JLabel AutomobileInfo = new JLabel("AutoMobile = "); 
	public static JLabel TravelInfo = new JLabel("Travel = "); 
	public static JLabel HouseInfo = new JLabel("House = "); 
	public static JLabel CommercialInfo = new JLabel("Commercial = "); 
	public static JLabel CalendarInfo = new JLabel("Calendar = "); 
	public static JLabel totalInfo = new JLabel("Total = "); 
	
	public static JTextField AutoTextField = new JTextField(5);
	public static JTextField TravelTextField = new JTextField(5);
	public static JTextField HouseTextField = new JTextField(5);
	public static JTextField CommercialTextField = new JTextField(5);
	public static JTextField CalendarTextField = new JTextField(5);
	public static JTextField totalTextField = new JTextField(5);
	
	public static JLabel idInfo = new JLabel("ID"); 
	public static JLabel firstNameInfo = new JLabel("First Name"); 
	public static JLabel lastNameInfo = new JLabel("Last Name"); 
	public static JLabel phoneNumInfo = new JLabel("Phone #"); 
	public static JLabel birthDateInfo = new JLabel("Birth Date");
	public static JLabel emailInfo = new JLabel("Email"); 
	public static JLabel memoInfo = new JLabel("Memo"); 
	public static JLabel addrStrtLabel= new JLabel("Address"); 
	
	public static JTextField idTextField = new JTextField();
	public static JTextField LastNameTextField = new JTextField(10);
	public static JTextField firstNameTextField = new JTextField(10);
	public static JTextField phoneNumField = new JTextField(10);
	public static JTextField phoneNumRearrangedField = new JTextField(10);
	public static JTextField birthDateField = new JTextField(10);
	public static JTextField birthDateRearrangedField = new JTextField(10);
	public static JTextField emailField = new JTextField(10);
	public static JTextField priCustIDField = new JTextField(10);
	public static JTextArea memoField = new JTextArea();
	public static JTextArea addrStrtField = new JTextArea();
	
	public static JTabbedPane tabbedPane = new JTabbedPane();
	public static JTabbedPane tabbedPaneForCustomerInfo = new JTabbedPane();
	public static JTabbedPane tabbedPaneForFamilyInfo = new JTabbedPane();
	
	public static JTable jTable_Personal_Info = new JTable(defaultTableModel_Personal_Info);
	public static JTable jTable_In_Progress_Info = new JTable(defaultTableModel_In_Progress_Info);
	public static JTable jTable_All_Info = new JTable(defaultTableModel_All_Info);
	public static JTable jTable_Complete_Info = new JTable(defaultTableModel_Complete_Info);
	public static JTable jTable_Automobile_Info = new JTable(defaultTableModel_Automobile_Info);
	public static JTable jTable_House_Info = new JTable(defaultTableModel_House_Info);
	public static JTable jTable_Traveler_Info = new JTable(defaultTableModel_Traveler_Info);
	public static JTable jTable_Family_Info = new JTable(defaultTableModel_Family_Info);
	public static JTable jTable_Commercial_Info = new JTable(defaultTableModel_Commercial_Info);
	public static JTable jTable_Calendar_Info = new JTable(defaultTableModel_Calendar_Info);
	public static JTable jTable_Reserved_Info = new JTable(defaultTableModel_Reserved_Info);
	public static JTable jTable_Claim_Info = new JTable(defaultTableModel_Claim_Info);

	public static JScrollPane jScrollPane_Personal_Info = new JScrollPane(jTable_Personal_Info);
	public static JScrollPane jScrollPane_All_Info = new JScrollPane(jTable_All_Info);
	public static JScrollPane jScrollPane_In_Progress_Info = new JScrollPane(jTable_In_Progress_Info);
	public static JScrollPane jScrollPane_Complete_Info = new JScrollPane(jTable_Complete_Info);
	public static JScrollPane jScrollPane_Automobile_Info = new JScrollPane(jTable_Automobile_Info);
	public static JScrollPane jScrollPane_House_Info = new JScrollPane(jTable_House_Info);
	public static JScrollPane jScrollPane_Traveler_Info = new JScrollPane(jTable_Traveler_Info);
	public static JScrollPane jScrollPane_Family_Info = new JScrollPane(jTable_Family_Info);
	public static JScrollPane jScrollPane_Commercial_Info = new JScrollPane(jTable_Commercial_Info);
	public static JScrollPane jScrollPane_Calendar_Info = new JScrollPane(jTable_Calendar_Info);
	public static JScrollPane jScrollPane_Reserved_Info = new JScrollPane(jTable_Reserved_Info);
	public static JScrollPane jScrollPane_Claim_Info = new JScrollPane(jTable_Claim_Info);

	public static JComponent panel_Personal_Info = jScrollPane_Personal_Info;
	public static JComponent panel_All_Info = jScrollPane_All_Info;
	public static JComponent panel_In_Progress_Info = jScrollPane_In_Progress_Info;
	public static JComponent panel_Complete_Info = jScrollPane_Complete_Info;
	public static JComponent panel_Automobile_Info = jScrollPane_Automobile_Info;
	public static JComponent panel_House_Info = jScrollPane_House_Info;
	public static JComponent panel_Traveler_Info = jScrollPane_Traveler_Info;
	public static JComponent panel_Family_Info = jScrollPane_Family_Info;
	public static JComponent panel_Commercial_Info = jScrollPane_Commercial_Info;
	public static JComponent panel_Calendar_Info = jScrollPane_Calendar_Info;
	public static JComponent panel_Reserved_Info = jScrollPane_Reserved_Info;
	public static JComponent panel_Claim_Info = jScrollPane_Claim_Info;
	
	public static JTextField jTextField = new JTextField(20);
	
	public static JButton jButton = new JButton("Search");
	public static JButton jButtonOpen = new JButton("Open");
	
	public static JButton jButtonForNewCustomer = new JButton("New ID");
	public static JButton jButtonForNewOther = new JButton("New");
	
	public static JButton jButtonUpdateForCustomer = new JButton("Update");
	public static JButton jButtonUpdateForOther = new JButton("Update");
	public static JButton jButtonRenewalForOther = new JButton("Renewal");
	public static JButton jButtonBackUp = new JButton("Backup");
	public static JButton jButtonRestore = new JButton("Restore");
	
	public static JMenuBar menuBar = new JMenuBar();
	
	public static JPanel jPanel_Search_Result = new JPanel();
	public static JPanel jPanel_Detailed_Search = new JPanel();
	public static JPanel jPanel_Memo_Field = new JPanel();
	public static JPanel jPanel_Family_Search = new JPanel();
	public static JPanel jPanel_Search = new JPanel();
	public static JPanel jPanel_Search_2 = new JPanel();
	public static JPanel jPanel_Search_3 = new JPanel();
	public static JPanel jPanel_Customer_Search = new JPanel();
	public static JPanel jPanel_New_Info = new JPanel(new GridLayout(0,1));
	public static JPanel jPanel_Update = new JPanel(new GridLayout(0, 1));
	public static JPanel jPanel_Other_Info = new JPanel();
	public static JPanel jPanel_Top_Section = new JPanel();
		
    public static JRadioButton customerButton = new JRadioButton("Customer - Name, ID, Phone Num");
    public static JRadioButton allButton = new JRadioButton("All");
	
	public GUIForCustomerCare() {
		...
		jButtonForNewCustomer.setBounds(0, 5, 75, 29);
		
		jButtonUpdateForCustomer.setBounds(93, 5, 75, 29);
		jButtonOpen.setBounds(186, 5, 75, 29);
		memoField.setEditable(false);
		
		jTextField.setBounds(377, 6, 168, 26);

		idTextField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		firstNameTextField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		LastNameTextField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		phoneNumField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		phoneNumRearrangedField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		birthDateField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		birthDateRearrangedField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		emailField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		priCustIDField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		addrStrtField.setBorder(new BevelBorder(BevelBorder.LOWERED));
		memoField.setBorder(new BevelBorder(BevelBorder.LOWERED));
        ...
        birthDateField.setBounds(99, 92, 103, 20);
        birthDateField.setEditable(false);
        
        birthDateRearrangedField.setBounds(204, 92, 102, 20);
        birthDateRearrangedField.setEditable(false);
        
        phoneNumField.setBounds(204, 114, 102, 20);
        phoneNumField.setEditable(false);
        
        phoneNumRearrangedField.setBounds(99, 114, 102, 20);
        phoneNumRearrangedField.setEditable(false);
        
        emailField.setBounds(99, 136, 207, 20);
        emailField.setEditable(false);
        
        addrStrtField.setLineWrap(true);
		addrStrtField.setWrapStyleWord(true);
		addrStrtField.setBounds(99, 158, 207, 62);
		addrStrtField.setEditable(false);
		
		AutomobileInfo.setBounds(140, 6, 90, 16);
		AutoTextField.setBounds(235, 0, 45, 29);
		AutoTextField.setEditable(false);
		
		TravelInfo.setBounds(393, 6, 56, 16);
		TravelTextField.setBounds(454, 0, 45, 29);
		TravelTextField.setEditable(false);
		
		HouseInfo.setBounds(285, 6, 58, 16);
		HouseTextField.setBounds(343, 0, 45, 29);
		...
		jButtonBackUp.setBounds(1184, 0, 75, 29);
		jButtonRestore.setBounds(1270, 0, 75, 29);
		
		CommercialInfo.setBounds(504, 6, 93, 16);
		CommercialTextField.setBounds(602, 0, 45, 29);
		CommercialTextField.setEditable(false);
		
		CalendarInfo.setBounds(652, 6, 73, 16);
		CalendarTextField.setBounds(730, 0, 45, 29);
        ...
        tabbedPane.addTab("Calendar", null, panel_Calendar_Info,
		...
		tabbedPaneForCustomerInfo.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				switch (GUIForCustomerCare.tabbedPaneForCustomerInfo.getSelectedIndex()) {
					case 0:
						CustomerCare.searchMember(DatabaseConstant.SEARCH_CLAIM, "");
						
						String rsForClaim = String.valueOf(GUIForCustomerCare.defaultTableModel_Claim_Info.getRowCount());
						GUIForCustomerCare.totalTextField.setText(rsForClaim);
						...
						CustomerCare.selectFamilyInfo(null);
						CustomerCare.selectAutomobileInfo("");
						CustomerCare.selectTravelInfo("");
						CustomerCare.selectCommercialInfo("");
						CustomerCare.selectHomeInfo("");
						CustomerCare.selectCalendarInfo("");
						break;
					case 1:
						CustomerCare.searchMember(DatabaseConstant.SEARCH_IN_COMPLETE, "");
						...
						break;
					case 2:
						CustomerCare.searchMember(DatabaseConstant.SEARCH_IN_PROGRESS, "");
						
						String rsForProgress = String.valueOf(GUIForCustomerCare.defaultTableModel_In_Progress_Info.getRowCount());    					
						GUIForCustomerCare.totalTextField.setText(rsForProgress);	
						GUIForCustomerCare.idTextField.setText("");
						GUIForCustomerCare.LastNameTextField.setText("");
						GUIForCustomerCare.firstNameTextField.setText("");
						GUIForCustomerCare.phoneNumField.setText("");
						...
						break;
					case 3:
						CustomerCare.searchMember(DatabaseConstant.SEARCH_RESERVED, "");
						
						String rsForReserved = String.valueOf(GUIForCustomerCare.defaultTableModel_Reserved_Info.getRowCount());    					
						GUIForCustomerCare.totalTextField.setText(rsForReserved);	
					...
					case 5:
						...
						String rsForPersonal = String.valueOf(GUIForCustomerCare.defaultTableModel_Personal_Info.getRowCount());
						GUIForCustomerCare.totalTextField.setText(rsForPersonal);
						GUIForCustomerCare.idTextField.setText("");
						GUIForCustomerCare.LastNameTextField.setText("");
						GUIForCustomerCare.firstNameTextField.setText("");
						GUIForCustomerCare.phoneNumField.setText("");
        ...
        jButtonForNewCustomer.setBorder(new BevelBorder(BevelBorder.RAISED));
        ...
        jButtonRestore.setBorder(raisedBorder);
        jButtonOpen.setBorder(raisedBorder);
        
        jPanel_Detailed_Search.setBorder(new SoftBevelBorder(BevelBorder.LOWERED));
        ...
        jPanel_Detailed_Search.add(birthDateRearrangedField);
        jPanel_Detailed_Search.add(phoneNumInfo);
        jPanel_Detailed_Search.add(phoneNumField);
        jPanel_Detailed_Search.add(phoneNumRearrangedField);
        ...
        jPanel_Other_Info.add(CalendarInfo);
        jPanel_Other_Info.add(CalendarTextField);
        ...
        jPanel_Other_Info.add(jButtonBackUp);
        jPanel_Other_Info.add(jButtonRestore);
		...
		jPanel_Search_3.add(jButtonOpen);
		...
		jPanel_Search_3.setBounds(763, 6, 400, 39);
		...
		jFrame.addWindowListener(new WindowAdapter() {
		    ...
		    public void windowOpened(WindowEvent we) {
				...
				CustomerCare.searchMember(DatabaseConstant.SEARCH_RESERVED, GUIForCustomerCare.jTextField.getText().trim());
		    }
		});
		
		ImageIcon icon;
		icon = new ImageIcon("/Users/Kang/Documents/workspace_calendar_error_organizing/CustomerCare/assets/bee.png");

...
public class GUIForMemberDialog {
	...
	public static JFrame jFrameForRegister = new JFrame();
	
	public static JDialog jDialog = new JDialog(jFrameForRegister, "Customer Info Input");
	public static JDialog jDialogForAuto = new JDialog(jFrameForRegister, "Automobile Info Input");
	public static JDialog jDialogForHome = new JDialog(jFrameForRegister, "Home Info Input");
	public static JDialog jDialogForTravel = new JDialog(jFrameForRegister, "Travel Info Input");
	public static JDialog jDialogForCommercial = new JDialog(jFrameForRegister, "Commercial Info Input");
	public static JDialog jDialogUpdate = new JDialog(jFrameForRegister, "Update");
	public static JDialog jDialogUpdateForAuto = new JDialog(jFrameForRegister, "Automobile Update");
	public static JDialog jDialogUpdateForHome = new JDialog(jFrameForRegister, "Home Update");
	public static JDialog jDialogUpdateForTravel = new JDialog(jFrameForRegister, "Travel Update");
	public static JDialog jDialogUpdateForCommercial = new JDialog(jFrameForRegister, "Commercial Update");

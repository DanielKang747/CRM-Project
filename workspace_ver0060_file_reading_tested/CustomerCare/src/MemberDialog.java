...
public class MemberDialog {
	...
	MemberDialog(int newInfo, int dialogMode) {			
		...
		if (dialogMode == customerCare.NEW_MODE) {
			if (newInfo == customerCare.CUSTOMER_MODE) {
			...
			else if (newInfo == customerCare.AUTOMOBILE_MODE) {
				fieldNamePanel.add(idLabel);
			...
			else if (newInfo == customerCare.HOME_MODE) {
			...
			else if (newInfo == customerCare.TRAVEL_MODE){
				fieldNamePanel.add(idLabel);
				fieldNamePanel.add(timeStampLabel);
				fieldNamePanel.add(txnTypeLabel);
				fieldNamePanel.add(procTypeLabel);
			...
			if (newInfo == customerCare.AUTOMOBILE_MODE) {
				if (customerCare.insertMemberForOther(customerCare.AUTOMOBILE_MODE, String.valueOf(customerCare.defaultTableModel_Automobile_Info.getValueAt(customerCare.jTable_Automobile_Info.getSelectedRow(), 0)), String.valueOf(customerCare.defaultTableModel_Automobile_Info.getValueAt(customerCare.jTable_Automobile_Info.getSelectedRow(), 1)))) {
				...
				if (customerCare.insertMemberForOther(customerCare.HOME_MODE, String.valueOf(customerCare.defaultTableModel_House_Info.getValueAt(customerCare.jTable_House_Info.getSelectedRow(), 0)), String.valueOf(customerCare.defaultTableModel_House_Info.getValueAt(customerCare.jTable_House_Info.getSelectedRow(), 1)))) {
					JOptionPane.showMessageDialog(jDialogUpdate, "Succesfully Created!");
